...
import com.udemy.ltp.spring_boot_camp.grade_submission.exception.GradeNotFoundException;
...
public class GradeServiceImplementation implements GradeService {
	...
	public Grade updateGrade(String score, Long studentId, Long courseId) {
		// Grade potentiallyUpdatedGrade = gradeRepository.findByStudentIdAndCourseId(studentId, courseId);
		Optional<Grade> existingGrade = gradeRepository.findByStudentIdAndCourseId(studentId, courseId);

		/*
		if(existingGrade.isPresent()) {
			Grade potentiallyUpdatedGrade = existingGrade.get();
